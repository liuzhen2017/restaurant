 ...
 */
var count = 1000;//调用接口获取数值
var COUNT_MAN = 3000;//设置消费满的值
...
$(".setUp-ul .setUp-ul-li").on("click",function(){
    switch ($(this).index()){
        ...
        case 5:
        	...
        	var shareUrl =encodeURIComponent('我分享一個優惠點餐APP');
        	fakeLink.setAttribute('href', 'whatsapp://send?text='+shareUrl);
        	fakeLink.setAttribute('data-action', 'share/whatsapp/share');
        	fakeLink.click();
        	//window.location="whatsapp://send?text="+ encodeURIComponent('我分享一個優惠點餐APP,  http://flqd.majiangyun.com:8899/OrderingSystem/index.html')+"&via=lopscoop";
            break;
        case 6:
